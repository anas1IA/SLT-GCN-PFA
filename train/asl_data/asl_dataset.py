...
ROOT_PATH = osp.join(os.path.dirname(os.path.abspath(__file__)), "dataset")


class ASLDataset(InMemoryDataset):

    def __init__(self, root=ROOT_PATH, transform=None, pre_transform=None, pre_filter=None):
...
if __name__ == "__main__":
    ...
    dataset = ASLDataset(root="./dataset")
